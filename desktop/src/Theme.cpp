...
QString Theme::styleSheet() const
{
    ...
    return QStringLiteral(
        ...
        "QMenu::indicator { width: 8px; height: 8px; margin-left: %PADpx; border-radius: 4px; }"
        ...
        "QLabel#panelTitle { color: %TEXT; font-size: 11px; font-weight: 700; letter-spacing: 1px;"
        "  text-transform: uppercase; padding: %PADpx %PAD2px; }"
        "QLabel#sectionLabel { color: %SECONDARY; font-size: 10px; font-weight: 700; letter-spacing: 1px;"
        "  padding: %PADpx %PADpx 0 %PADpx; }"
        "QLabel#workspaceContext { color: %SECONDARY; font-size: 10px; font-weight: 700; letter-spacing: 1px;"
        "  padding-left: %PADpx; }"
        "QLabel#stripValue { color: %SECONDARY; font-size: 10px; font-weight: 600; }"
